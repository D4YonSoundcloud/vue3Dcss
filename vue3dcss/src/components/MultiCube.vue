<template>
  <div v-bind:style="multiCubeContainer" class="multi-cube-wrapper">
    ...
    <div class="cube" v-bind:style="cube" v-for="(cube,index) in multiCubeArray" :key="index">
    ...
    computed:{
      ...
      multiCubeContainer(){
        return{
          display: 'flex',
          flexFlow: 'row wrap',
          width: this.multiCubeContainerWidthHeight + 'px',
          height: this.multiCubeContainerWidthHeight + 'px',
          position: 'relative',
